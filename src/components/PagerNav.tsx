 ...
 * cousins of the menu buttons: the same pixel-round plate, plus a section
 * kicker and the destination's title (no thumbnail). The arrows alone
 * carry direction; only assistive tech hears "previous"/"next".
