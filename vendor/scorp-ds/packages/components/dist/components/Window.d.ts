 ...
 * ```
 */
export declare function Window({ title, status, actions, variant, titleAs: TitleTag, scroll, children, className, bodyClassName, }: WindowProps): import("react/jsx-runtime").JSX.Element;
