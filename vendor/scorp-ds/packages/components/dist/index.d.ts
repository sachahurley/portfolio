...
export type { BoxProps, BoxSpace, BoxBackground, BoxBorder, BoxElement, } from './primitives/Box';
...
export type { GridProps, GridGap, GridColumns, GridColumnCount, GridBreakpoint, GridAlign, } from './primitives/Grid';
